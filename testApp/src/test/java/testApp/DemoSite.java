...
public class DemoSite {
	...
	public void test() {
		...
		findLogin.click();
		WebElement createUsername = driver.findElementByCssSelector("body > table > tbody > tr > td.auto-style1 > form > div > center > table > tbody > tr > td:nth-child(1) > div > center > table > tbody > tr:nth-child(1) > td:nth-child(2) > p > input");
				createUsername.sendKeys("user1");
		WebElement createPassword = driver.findElementByCssSelector("body > table > tbody > tr > td.auto-style1 > form > div > center > table > tbody > tr > td:nth-child(1) > div > center > table > tbody > tr:nth-child(2) > td:nth-child(2) > p > input[type=\"password\"]");
		...
		assertEquals(driver.findElementByCssSelector("body > table > tbody > tr > td.auto-style1 > big > blockquote > blockquote > font > center > b").getText(), "**Successful Login**");
